...
pub fn build() -> Value {
    json!({
        ...
        "operations": [
            ...
            op("channels.create", "POST", "create a new channel", Some(channels_create_selector())),
            op("channels.update", "PUT", "update channel fields (PATCH semantics)", Some(channels_update_selector())),
            op("channels.status", "POST", "set channel status (1=enabled, 2=disabled, 3=auto)", Some(channels_status_selector())),
            ...
            op("tokens.create", "POST", "create a caller token", Some(tokens_create_selector())),
            op("tokens.update", "PUT", "update token fields", Some(tokens_update_selector())),
            op("tokens.key", "POST", "regenerate token key", Some(tokens_key_selector())),
            ...
            op("options.set", "PUT", "set a NewAPI option", Some(options_set_selector())),
